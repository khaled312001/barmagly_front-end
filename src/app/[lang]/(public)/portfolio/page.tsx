            ...
            <section className="relative pt-48 pb-24 lg:pt-56 lg:pb-32 overflow-hidden bg-brand-primary">
                ...
                <div className="section-container relative z-10 text-center">
                    ...
                    >
                        ...
                        <motion.h1 variants={staggerItem} className="text-5xl md:text-8xl font-display font-black text-brand-text mb-8 tracking-tighter">
            ...
            {featuredProject && (
                <section className="pb-32 relative">
                    <div className="section-container">
                        <SectionReveal>
                            <div className="group relative glass-card p-2 rounded-[2.5rem] overflow-hidden bg-brand-dark/50 border-brand-border shadow-2xl">
                                ...
                                <div className="overflow-hidden rounded-[2.2rem]">
                                    ...
                                    <div className="p-12 lg:p-20 flex flex-col justify-center bg-brand-surface relative overflow-hidden">
                                        <div className="absolute top-0 right-0 p-10 font-display font-black text-[120px] leading-none text-brand-text/[0.03] select-none pointer-events-none">
                                            01
                                        </div>
                                        <div className="relative z-10">
                                            ...
                                            <h2 className="text-4xl md:text-5xl font-display font-black text-brand-text mb-8 tracking-tight">
                                            ...
                                            <div className="flex flex-wrap gap-6">
                                                ...
                                                {featuredProject.content && featuredProject.content.startsWith('http') && (
                                                    <a href={featuredProject.content} target="_blank" rel="noopener noreferrer">
                                                        <Button variant="outline" size="lg" icon={<ExternalLink size={20} />} className="px-10 h-16 rounded-xl font-bold border-brand-border hover:border-brand-accent/30 transition-all">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-10 mb-20">
                            ...
                            {categories.map(cat => (
                                <button
                                    ...
                                    className={`px-8 py-3 rounded-xl font-display font-bold text-xs tracking-widest uppercase transition-all duration-300 border ${filter === cat
                                        ...
                                        : 'bg-brand-surface/50 text-brand-muted border-brand-border hover:border-brand-accent/30'
                                        }`}
                                >
                        ...
                        <div className="relative group w-full lg:w-96">
                            ...
                            <input
                                ...
                                className="w-full h-14 bg-brand-surface border border-brand-border rounded-2xl ps-14 pe-6 text-brand-text placeholder:text-brand-muted/40 focus:outline-none focus:border-brand-accent/30 focus:shadow-neon-cyan/20 transition-all font-light"
                            />
                        </div>
                    </div>
                                ...
                                >
                                    ...
                                    <div className="relative h-full glass-card overflow-hidden hover:border-brand-accent/50 transition-all duration-500 rounded-2xl flex flex-col group/card">
                                        <Link href={`/${lang}/portfolio/${project.slug}`}>
                                            <div className="px-8 pt-8 pb-4 border-b border-brand-border flex items-center justify-between">
                                            ...
                                            <div className="p-8 flex-1 flex flex-col">
                                                ...
                                                <div className="flex flex-wrap gap-2 mb-8">
                                                    {project.technologies.slice(0, 3).map((tech) => (
                                                        <span key={tech} className="px-3 py-1 text-[10px] uppercase tracking-widest font-bold bg-brand-surface border border-brand-border rounded-md text-brand-accent/80 hover:bg-brand-accent/10 hover:border-brand-accent/30 transition-colors">
                                                            {tech}
                                                        </span>
                                                    ))}
                                                ...
                                                <Button
                                                    variant="outline"
                                                    size="lg"
                                                    className="w-full border-brand-border group-hover/card:border-brand-accent/50 group-hover/card:bg-brand-accent/5"
                                                >
